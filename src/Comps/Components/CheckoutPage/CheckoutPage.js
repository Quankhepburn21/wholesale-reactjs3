...
// TC số 11: Check đầu vào ở input đúng dạng điều kiện đặt ra cho validate dữ liệu
...
function CheckoutPage() {
  ...
  const dispatch = useDispatch();// Bắn đi 1 action     
